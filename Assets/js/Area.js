...
// variables generales 
console.log("zona de areas");
const frm = document.querySelector('#frmArea');
...
const nombre_area = document.querySelector('#nombre_area');
const descripcion = document.querySelector('#descripcion');
const descripcion_area = document.querySelector('#descripcion_area');
